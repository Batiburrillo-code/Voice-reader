const u = "https://huggingface.co/diffusionstudio/piper-voices/resolve/main", B = new URL("./", import.meta.url).href, x = new URL("./piper_phonemize", import.meta.url).href, c = {
